...
namespace core::layers
{
    ...
    private:
         ...
         */
        bool on_window_frame_resize(core::events::window_frame_resize_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_window_focus_lost(core::events::window_focus_lost_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_window_focus_gain(core::events::window_focus_gain_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_keyboard_keypress(core::events::keyboard_keypress_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_keyboard_keyrelease(core::events::keyboard_keyrelease_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_keyboard_keyrepeat(core::events::keyboard_keyrepeate_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_keyboard_charinput(core::events::keyboard_keychar_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_cursor_move(core::events::mouse_cursorpos_change_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_mouse_button_press(core::events::mouse_button_press_event &e);
         ...
         * @return True if the event was handled, false otherwise.
         */
        bool on_mouse_button_release(core::events::mouse_button_release_event &e);
